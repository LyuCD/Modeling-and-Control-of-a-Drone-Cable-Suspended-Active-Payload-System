...
private:
  ...
  //payload
  rclcpp::Publisher<geometry_msgs::msg::Point>::SharedPtr pub_payload_pos_{nullptr};
  ...
  ignition::math::v6::Vector3<double> payload_position;
  ignition::math::v6::Vector3<double> payload_velocity;
  ignition::math::v6::Vector3<double> prev_position;
  // Cable direction and derivative
  Eigen::Vector3d q;
  Eigen::Vector3d q_dot;

  // force vector (no initial value!)
  ignition::math::v6::Vector3<double> f_vec;

  double mD;  // drone mass
  double mL;  // payload mass
