...
def generate_launch_description():
    ...
    return LaunchDescription([
        ...
        Node(
            package="sjtu_drone_control",
            executable="drone_position_control",  # 确保你的 setup.py 里有 entry_points 注册
            namespace=model_ns,
            output="screen"
        ),
        ...
        Node(
            package="sjtu_drone_control",
            executable="payload_mpc_controller",   # ✅ 使用 entry_point 名称
            namespace=model_ns,
            output="screen"
        ),
        ...
        Node(
            package="sjtu_drone_control",
            executable="plot_tools",   # ✅ 使用 entry_point 名称
            namespace=model_ns,
            output="screen"
        ),
    ])
